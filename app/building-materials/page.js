...
export default function BuildingMaterials() {
  ...
  const buildingProducts = [
    { id: 1, name: "Cement 50kg", price: "KSh 850" },
    { id: 2, name: "Construction Nails", price: "KSh 320" },
    { id: 3, name: "Roofing Sheets", price: "KSh 1,200" },
    { id: 4, name: "Sand 1 Ton", price: "KSh 3,500" },
    { id: 5, name: "Gravel 1 Ton", price: "KSh 4,200" },
    { id: 6, name: "Steel Bars", price: "KSh 950" },
  ];
  ...
  return (
    <div className={`font-sans flex flex-col min-h-screen ${isDark ? 'bg-[url("/dARKBarkground.PNG")]' : 'bg-[url("/LIGHTBarkground.PNG")]'}`}>
      ...
      <div className={`flex items-center w-full ${isDark ? 'bg-black/80' : 'bg-white/80'} backdrop-blur-sm p-4`}>
        ...
        <h1 className={`text-2xl font-bold ${isDark ? 'text-white' : 'text-gray-800'}`}>Building Materials</h1>
      </div>
