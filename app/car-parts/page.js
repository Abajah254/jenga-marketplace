...
export default function CarParts() {
  ...
  const carProducts = [
    { id: 1, name: "Brake Pads Set", price: "KSh 4,500" },
    { id: 2, name: "Car Battery 60Ah", price: "KSh 12,000" },
    { id: 3, name: "Engine Oil 5W-30", price: "KSh 2,800" },
    { id: 4, name: "Air Filter", price: "KSh 1,200" },
    { id: 5, name: "Spark Plugs Set", price: "KSh 3,500" },
    { id: 6, name: "Car Bulbs Kit", price: "KSh 1,800" },
  ];
  ...
  return (
    <div className={`font-sans flex flex-col min-h-screen ${isDark ? 'bg-[url("/dARKBarkground.PNG")]' : 'bg-[url("/LIGHTBarkground.PNG")]'}`}>
      ...
      <div className={`flex items-center w-full ${isDark ? 'bg-black/80' : 'bg-white/80'} backdrop-blur-sm p-4`}>
        ...
        <h1 className={`text-2xl font-bold ${isDark ? 'text-white' : 'text-gray-800'}`}>Car Parts</h1>
      </div>
