...
export default function Plumbing() {
  ...
  const plumbingProducts = [
    { id: 1, name: "PVC Pipes 1 inch", price: "KSh 1,800" },
    { id: 2, name: "Water Taps Standard", price: "KSh 2,500" },
    { id: 3, name: "Pipe Wrench 12 inch", price: "KSh 1,200" },
    { id: 4, name: "Pipe Joints Set", price: "KSh 850" },
    { id: 5, name: "Water Pump 0.5HP", price: "KSh 8,500" },
    { id: 6, name: "Pipe Seal Tape", price: "KSh 150" },
  ];
  ...
  return (
    <div className={`font-sans flex flex-col min-h-screen ${isDark ? 'bg-[url("/dARKBarkground.PNG")]' : 'bg-[url("/LIGHTBarkground.PNG")]'}`}>
      ...
      <div className={`flex items-center w-full ${isDark ? 'bg-black/80' : 'bg-white/80'} backdrop-blur-sm p-4`}>
        ...
        <h1 className={`text-2xl font-bold ${isDark ? 'text-white' : 'text-gray-800'}`}>Plumbing Supplies</h1>
      </div>
