...
export default function Hardware() {
  ...
  const hardwareProducts = [
    { id: 1, name: "Steel Nails (1kg)", price: "KSh 450" },
    { id: 2, name: "Claw Hammer", price: "KSh 1,200" },
    { id: 3, name: "Screwdriver Set", price: "KSh 800" },
    { id: 4, name: "Adjustable Wrench", price: "KSh 2,500" },
  ];
  ...
  return (
    <div className={`font-sans flex flex-col min-h-screen ${isDark ? 'bg-[url("/dARKBarkground.PNG")]' : 'bg-[url("/LIGHTBarkground.PNG")]'}`}>
      ...
      <div className={`flex items-center w-full ${isDark ? 'bg-black/80' : 'bg-white/80'} backdrop-blur-sm p-4`}>
        ...
        <h1 className={`text-2xl font-bold ${isDark ? 'text-white' : 'text-gray-800'}`}>Hardware Products</h1>
      </div>
